...
class CierresCaja(models.Model):
    ...
    id_empleado_cierre = models.ForeignKey(
        ...
        related_name='cierrescaja_id_empleado_cierre_set',
        blank=True,
        null=True
    )
    ...
    def __str__(self):
        return f"Caja #{self.id_cierre_caja} - {self.fecha_apertura.date()}"
...
class Pagos(models.Model):
    ...
    def __str__(self):
        return f"Pago #{self.id_pago} - {self.monto} ({self.fecha_hora_pago})"
...
class Egresos(models.Model):
    ...
    id_cierre_caja = models.ForeignKey(CierresCaja, models.DO_NOTHING, db_column='id_cierre_caja', blank=True, null=True)
    ...
    def __str__(self):
        return f"Egreso #{self.id_egreso} - {self.monto} ({self.fecha_egreso})"
